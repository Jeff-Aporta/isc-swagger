...
(function () {
  ...
  /** Lo que venga en `?s=`: es entrada externa, se lee campo a campo. */
  var estado: { theme?: string; palette?: string; embed?: unknown } = {};
  ...
  function aplicar(tema: string | undefined, paleta: string | undefined): void {
